...
display.o: display.cpp display.hpp board.o text.o
	$(COMPILER) -c display.cpp  $(FLAGS)

controller.o: controller.cpp controller.hpp board.o
	$(COMPILER) -c controller.cpp  $(FLAGS)

levelEditor.o: levelEditor.cpp levelEditor.hpp board.o grid.o text.o
	$(COMPILER) -c levelEditor.cpp $(FLAGS)

board.o: board.cpp board.hpp gameObject.o
