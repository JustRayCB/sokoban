...
main: main.cpp display.o controller.o rectangle.o gameObject.o board.o text.o
	$(COMPILER) -o main main.cpp display.o rectangle.o gameObject.o board.o controller.o text.o $(FLAGS)
